...
function SignupContent() {
    ...
    const handleSocialLogin = async (provider: 'google' | 'kakao') => {
        ...
        try {
            ...
            let redirectUrl = `${window.location.origin}/auth/callback?role_type=creator`
                        ...
                        {successMessage ? (
                            ...
                            <form onSubmit={handleSignup} className="space-y-4">
                                <div className="space-y-2">
                                    <Label htmlFor="user-name">이름 (또는 활동명)</Label>
                                    <Input
                                        id="user-name"
                                        placeholder="홍길동"
                                        value={name}
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <Button variant="outline" type="button" className="bg-[#FAE100] hover:bg-[#FAE100]/90 text-black border-none dark:bg-[#FAE100] dark:hover:bg-[#FAE100]/90 dark:text-black" onClick={() => handleSocialLogin('kakao')}>
...
export default function SignupPage() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-muted/30 flex items-center justify-center">로딩 중...</div>}>
            <SignupContent />
        </Suspense>
    )
}
