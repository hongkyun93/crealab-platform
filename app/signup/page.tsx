...
export default function SignupPage() {
    ...
    const handleSocialLogin = async (provider: 'google' | 'kakao', role: 'brand' | 'creator') => {
        ...
        try {
            ...
            // DO NOT pass role_type in redirect URL - let onboarding handle role selection
    ...
    const handleSignup = async (e: React.FormEvent, role: 'brand' | 'creator') => {
        e.preventDefault()
        setIsLoading(true)
        setError("")
        setSuccessMessage("")
        ...
        try {
            const { error } = await supabase.auth.signUp({
                ...
                options: {
                    data: {
                        name: name,
                        // DO NOT set role/role_type here - let onboarding handle it
                    },
                ...
                <Card className="w-full max-w-md">
                    ...
                    <CardContent>
                        {successMessage ? (
                            ...
                            <form onSubmit={(e) => handleSignup(e, 'creator')} className="space-y-4">
