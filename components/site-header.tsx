            ...
            <div className="container flex h-14 items-center max-w-[1920px] px-3 sm:px-6 md:px-8">
                <div className="mr-4 flex">
                    <Link href="/" className="mr-3 sm:mr-6 flex items-center space-x-2">
                        ...
                        <span className="hidden md:inline-block text-[10px] font-bold text-primary/60 bg-primary/10 px-2 py-0.5 rounded-full dark:text-primary dark:bg-primary/20">V4.4.0</span>
                    </Link>
