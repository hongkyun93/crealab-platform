...
import { ArrowRight, CheckCircle2, Clock, DollarSign, Download, FileText, Loader2, Receipt, Search, Users, Wallet } from "lucide-react"
...
import {
    type Settlement, type CreatorBankInfo,
    STATUS_CONFIG, PROPOSAL_TYPE_LABELS,
    getMonthOptions, exportSettlementsToCSV,
} from "./types/settlement"

// ─── Local prop types ─────────────────────────────────────────────────────────
interface RevenueSplit { creator_id: string; split_ratio: number }
