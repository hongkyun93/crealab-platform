...
ALTER TABLE brand_proposals ADD COLUMN IF NOT EXISTS content_final_url TEXT;
ALTER TABLE brand_proposals ADD COLUMN IF NOT EXISTS content_clean_url TEXT;
ALTER TABLE brand_proposals ADD COLUMN IF NOT EXISTS content_submission_file_url TEXT;
ALTER TABLE brand_proposals ADD COLUMN IF NOT EXISTS content_submission_version NUMERIC;
ALTER TABLE brand_proposals ADD COLUMN IF NOT EXISTS content_submission_date TIMESTAMPTZ;
