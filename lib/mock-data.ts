import { CreatorMoment, Product } from "@/lib/types";
...
export const MOCK_EVENTS: CreatorMoment[] = [
    // Lifestyle & Living
    {
        ...
        title: "30평대 아파트 리모델링", date: "2026년 3월",
        description: "구축 아파트 올수리 리모델링 과정을 담습니다.",
        tags: ["인테리어", "리모델링", "랜선집들이"], followers: 45000,
        targetProduct: "바닥재, 조명, 욕실 자재", momentDate: "2026년 3월", postingDate: "2026년 4월", isMock: true
    },
    {
        ...
        title: "봄맞이 대청소 & 수납 정리", date: "2026년 4월",
        description: "겨울 묵은 짐을 정리하고 수납공간을 재배치합니다.",
        tags: ["청소", "정리정돈", "수납"], followers: 12000,
        targetProduct: "수납함, 정리 용품, 로봇청소기", momentDate: "2026년 4월", postingDate: "2026년 4월", isMock: true
    },
    {
        ...
        title: "거실 베란다 정원 꾸미기", date: "2026년 3월",
        description: "삭막한 베란다를 플랜테리어 공간으로 바꿉니다.",
        tags: ["식물", "플랜테리어", "홈가드닝"], followers: 28000,
        targetProduct: "대형 화분, 식물 생장등", momentDate: "2026년 3월", postingDate: "2026년 3월", isMock: true
    },
    {
        ...
        title: "첫 자취 시작 & 이사", date: "2026년 2월",
        description: "대학생의 첫 자취방 꾸미기 브이로그입니다.",
        tags: ["자취", "이사", "원룸"], followers: 5000,
        targetProduct: "매트리스, 1인용 소파, 미니 밥솥", momentDate: "2026년 2월", postingDate: "2026년 2월", isMock: true
    },
    {
        ...
        title: "주방 식기 전면 교체", date: "2026년 5월",
        description: "오래된 플라스틱 용기를 버리고 유리/스테인리스로 교체합니다.",
        tags: ["주방", "제로웨이스트", "살림"], followers: 33000,
        targetProduct: "밀폐용기 세트, 원목 도마", momentDate: "2026년 5월", postingDate: "2026년 5월", isMock: true
    },
    // Health & Fitness
    {
        ...
        title: "여름 대비 바디프로필", date: "2026년 6월",
        description: "6월 촬영을 목표로 체지방 5%에 도전합니다.",
        tags: ["헬스", "바디프로필", "식단"], followers: 120000,
        targetProduct: "단백질 보충제, 닭가슴살 도시락", momentDate: "2026년 6월", postingDate: "2026년 6월", isMock: true
    },
    {
        ...
        title: "결혼식 전 -5kg 감량", date: "2026년 4월",
        description: "친구 결혼식 축가를 위해 급찐급빠 다이어트 돌입!",
        tags: ["다이어트", "급찐급빠", "홈트"], followers: 8000,
        targetProduct: "다이어트 보조제, 샐러드", momentDate: "2026년 4월", postingDate: "2026년 4월", isMock: true
    },
    {
        ...
        title: "야외 요가 원데이 클래스", date: "2026년 5월",
        description: "구독자들과 한강에서 야외 요가를 진행합니다.",
        tags: ["요가", "야외운동", "이벤트"], followers: 42000,
        targetProduct: "요가 매트, 요가복, 이온 음료", momentDate: "2026년 5월", postingDate: "2026년 5월", isMock: true
    },
    {
        ...
        title: "서울 하프 마라톤 출전", date: "2026년 4월",
        description: "크루원 20명과 함께 하프 마라톤 완주에 도전합니다.",
        tags: ["러닝", "마라톤", "크루"], followers: 65000,
        targetProduct: "러닝화, 스포츠 테이핑", momentDate: "2026년 4월", postingDate: "2026년 4월", isMock: true
    },
    {
        ...
        title: "자연 암벽 등반 여행", date: "2026년 5월",
        description: "실내를 벗어나 국내 암벽 명소로 2박 3일 떠납니다.",
        tags: ["클라이밍", "암벽등반", "아웃도어"], followers: 23000,
        targetProduct: "클라이밍 팬츠, 초크, 캠핑 장비", momentDate: "2026년 5월", postingDate: "2026년 6월", isMock: true
    },
    // Beauty & Fashion
    {
        ...
        title: "환절기 스킨케어 루틴", date: "2026년 3월",
        description: "미세먼지와 건조함 잡는 나만의 루틴을 공개합니다.",
        tags: ["스킨케어", "환절기", "피부관리"], followers: 350000,
        targetProduct: "진정 앰플, 마스크팩", momentDate: "2026년 3월", postingDate: "2026년 3월", isMock: true
    },
    {
        ...
        title: "벚꽃 놀이 데이트룩 코디", date: "2026년 4월",
        description: "벚꽃 축제 인생샷 건지는 색감 깡패 코디 모음.",
        tags: ["OOTD", "봄코디", "데이트룩"], followers: 120000,
        targetProduct: "원피스, 가디건, 미니백", momentDate: "2026년 4월", postingDate: "2026년 4월", isMock: true
    },
    {
        ...
        title: "명품 vs 저렴이 반반 메이크업", date: "2026년 3월",
        description: "백화점 파운데이션과 로드샵 제품을 반반 비교합니다.",
        tags: ["메이크업", "비교리뷰", "저렴이"], followers: 18000,
        targetProduct: "파운데이션, 쿠션", momentDate: "2026년 3월", postingDate: "2026년 3월", isMock: true
    },
    {
        ...
        title: "5월의 신부, 친구 결혼식", date: "2026년 5월",
        description: "가장 친한 친구 결혼식 사회를 보게 되었습니다.",
        tags: ["하객룩", "결혼식", "정장"], followers: 9000,
        targetProduct: "정장 셋업, 구두, 쥬얼리", momentDate: "2026년 5월", postingDate: "2026년 5월", isMock: true
    },
    {
        ...
        title: "도쿄 빈티지 쇼핑 투어", date: "2026년 6월",
        description: "도쿄 오모테산도 명품 빈티지 샵을 털어봅니다.",
        tags: ["일본여행", "쇼핑", "하울"], followers: 210000,
        targetProduct: "캐리어, 여행용 파우치", momentDate: "2026년 6월", postingDate: "2026년 6월", isMock: true
    },
    ...
    },
    {
        ...
        title: "화이트 감성 데스크 셋업 완성", date: "2026년 5월",
        ...
        targetProduct: "키보드, 마우스, 모니터암", momentDate: "2026년 5월", postingDate: "2026년 5월", isMock: true
    },
    {
        ...
        title: "입문용 미러리스 카메라 추천 가이드", date: "2026년 4월",
        ...
        targetProduct: "카메라 바디, 렌즈", momentDate: "2026년 4월", postingDate: "2026년 4월", isMock: true
    },
    {
        ...
        title: "노이즈 캔슬링 헤드폰 3종 비교", date: "2026년 6월",
        description: "소니, 보스, 애플 헤드폰을 비행기 소음 환경에서 비교합니다.\n• 희망 협찬: 헤드폰 대여 또는 협찬\n• 이벤트 시기: 6월 초 해외 출장 시 테스트\n• 업로드 예정: 6월 15일",
        tags: ["음향기기", "헤드폰", "비교리뷰"], followers: 23000,
        targetProduct: "헤드폰", momentDate: "2026년 6월", postingDate: "2026년 6월", isMock: true
    },
    {
        ...
        title: "판교 개발자의 재택근무 브이로그", date: "2026년 3월",
        description: "효율적인 업무를 위한 장비와 소프트웨어를 소개합니다.\n• 희망 협찬: 인체공학 의자, 버티컬 마우스, 생산성 앱 구독권\n• 이벤트 시기: 3월 한 달간\n• 업로드 예정: 매주 금요일 퇴근 후",
        tags: ["개발자", "재택근무", "생산성"], followers: 55000,
        targetProduct: "인체공학 의자, 마우스", momentDate: "2026년 3월", postingDate: "2026년 3월", isMock: true
    },
    ...
    // --- Beauty & Fashion (Expanding) ---
    {
        ...
        title: "여름 쿨톤 인생 립스틱 찾기", date: "2026년 5월",
        description: "여쿨라에게 형광등 켜주는 핑크 립 10종 발색 비교.\n• 희망 협찬: 쿨톤 립 신상, 블러셔\n• 이벤트 시기: 5월 초\n• 업로드 예정: 5월 10일",
        tags: ["퍼스널컬러", "여름쿨톤", "립추천"], followers: 105000,
        targetProduct: "틴트, 립스틱", momentDate: "2026년 5월", postingDate: "2026년 5월", isMock: true
    },
    {
        ...
        title: "남자 면접 프리패스 헤어 & 메이크업", date: "2026년 9월",
        description: "하반기 공채 시즌 대비 깔끔한 인상 만들기 튜토리얼.\n• 희망 협찬: 남성용 비비크림, 헤어 왁스, 눈썹 칼\n• 이벤트 시기: 9월 공채 시즌\n• 업로드 예정: 9월 1일",
        tags: ["남자메이크업", "면접", "그루밍"], followers: 32000,
        targetProduct: "남성 화장품, 헤어제품", momentDate: "2026년 8월", postingDate: "2026년 9월", isMock: true
    },
    {
        ...
        title: "키 155cm의 비율 좋아보이는 가을 코디", date: "2026년 9월",
        description: "수선 없이 입는 슬랙스와 부츠컷 데님 추천.\n• 희망 협찬: 키작녀 전용 쇼핑몰 의류, 굽 있는 운동화\n• 이벤트 시기: 9월 중순\n• 업로드 예정: 9월 20일 룩북",
        tags: ["키작녀", "가을코디", "데일리룩"], followers: 180000,
        targetProduct: "바지, 운동화", momentDate: "2026년 9월", postingDate: "2026년 9월", isMock: true
    },
    {
        ...
        title: "성수동 팝업스토어 투어 룩", date: "2026년 4월",
        description: "요즘 핫한 성수동 팝업들을 돌며 입기 좋은 힙한 코디.\n• 희망 협찬: 오버핏 후드, 카고 팬츠, 메신저백\n• 이벤트 시기: 4월 주말\n• 업로드 예정: 4월 15일",
        tags: ["스트릿", "성수동", "OOTD"], followers: 210000,
        targetProduct: "스트릿 의류, 가방", momentDate: "2026년 4월", postingDate: "2026년 4월", isMock: true
    },
    {
        ...
        title: "집에서 하는 셀프 젤네일 꿀팁", date: "2026년 3월",
        description: "샵 가지 않고도 퀄리티 있게! 지속력 높이는 방법 공개.\n• 희망 협찬: 젤네일 키트, 램프, 파츠\n• 이벤트 시기: 3월 초\n• 업로드 예정: 3월 5일",
        tags: ["셀프네일", "젤네일", "취미"], followers: 28000,
        targetProduct: "젤네일 세트", momentDate: "2026년 3월", postingDate: "2026년 3월", isMock: true
    },
    ...
    // --- Food & Cooking (Expanding) ---
    {
        ...
        title: "전국 빵지순례 1탄: 대전 성심당", date: "2026년 4월",
        description: "튀김소보로 외에 숨겨진 존맛 빵들을 털어옵니다.\n• 희망 협찬: KTX, 대전 숙소, 빵 보관 용기\n• 이벤트 시기: 4월 초\n• 업로드 예정: 4월 8일 먹방",
        tags: ["빵지순례", "디저트", "먹방"], followers: 75000,
        targetProduct: "밀폐용기, 여행상품", momentDate: "2026년 4월", postingDate: "2026년 4월", isMock: true
    },
    {
        ...
        title: "배달비 아끼는 만원 일주일 식단", date: "2026년 5월",
        description: "고물가 시대, 식비 방어를 위한 초가성비 레시피.\n• 희망 협찬: 대용량 식자재, 소스류, 밀키트\n• 이벤트 시기: 5월 한 주간 도전\n• 업로드 예정: 5월 말 결산 영상",
        tags: ["절약", "집밥", "식비방어"], followers: 330000,
        targetProduct: "식료품, 주방용품", momentDate: "2026년 5월", postingDate: "2026년 5월", isMock: true
    },
    {
        ...
        title: "맛있어서 놀라는 비건 데이트 맛집", date: "2026년 6월",
        description: "비건이 아닌 친구도 만족하는 서울 비건 레스토랑 탐방.\n• 희망 협찬: 비건 화장품, 텀블러, 친환경 제품\n• 이벤트 시기: 6월 주말\n• 업로드 예정: 6월 10일",
        tags: ["비건", "채식", "친환경"], followers: 15000,
        targetProduct: "비건 식품, 친환경 제품", momentDate: "2026년 6월", postingDate: "2026년 6월", isMock: true
    },
    {
        ...
        title: "전통주 칵테일 홈파티", date: "2026년 12월",
        description: "연말 파티에 어울리는 전통주 하이볼 레시피 소개.\n• 희망 협찬: 전통주, 예쁜 잔, 파티 용품\n• 이벤트 시기: 12월 24일\n• 업로드 예정: 12월 20일 미리보기",
        tags: ["홈파티", "전통주", "칵테일"], followers: 92000,
        targetProduct: "주류, 글라스", momentDate: "2026년 12월", postingDate: "2026년 12월", isMock: true
    },
    {
        ...
        title: "그리들로 만드는 캠핑 요리 5선", date: "2026년 10월",
        description: "삼겹살부터 볶음밥까지 그리들 하나로 끝내는 코스.\n• 희망 협찬: 그리들, 버너, 밀키트, 캠핑 체어\n• 이벤트 시기: 10월 가을 캠핑\n• 업로드 예정: 10월 15일",
        tags: ["캠핑요리", "먹방", "가을캠핑"], followers: 160000,
        targetProduct: "캠핑 조리도구", momentDate: "2026년 10월", postingDate: "2026년 10월", isMock: true
    },
    ...
    // --- Travel & Activity (Expanding) ---
    {
        ...
        title: "나홀로 떠나는 교토 감성 여행", date: "2026년 11월",
        ...
        targetProduct: "여행 필수품, 카메라", momentDate: "2026년 11월", postingDate: "2026년 11월", isMock: true
    },
    {
        ...
        title: "양양 서핑 강습 브이로그", date: "2026년 7월",
        description: "서핑 초보의 좌충우돌 강습기와 양양 핫플 소개.\n• 희망 협찬: 래쉬가드, 선스틱, 액션캠 악세서리\n• 이벤트 시기: 7월 서핑 시즌\n• 업로드 예정: 8월 초",
        tags: ["서핑", "양양", "액티비티"], followers: 45000,
        targetProduct: "수영복, 액션캠", momentDate: "2026년 7월", postingDate: "2026년 8월", isMock: true
    },
    {
        ...
        title: "경차로 떠나는 스텔스 차박", date: "2026년 5월",
        description: "퇴근 후 바로 떠나는 미니멀 차박 노하우.\n• 희망 협찬: 차박 텐트, 차량용 매트, 보조배터리\n• 이벤트 시기: 5월 주말\n• 업로드 예정: 5월 20일",
        tags: ["차박", "미니멀캠핑", "여행"], followers: 27000,
        targetProduct: "차박 용품", momentDate: "2026년 5월", postingDate: "2026년 5월", isMock: true
    },
    {
        ...
        title: "5성급 호텔 라운지 & 수영장 100% 즐기기", date: "2026년 8월",
        description: "서울 호캉스 추천 및 부대시설 이용 꿀팁.\n• 희망 협찬: 수영복, 호캉스룩, 캐리어\n• 이벤트 시기: 8월 휴가철\n• 업로드 예정: 8월 10일",
        tags: ["호캉스", "호텔리뷰", "휴가"], followers: 130000,
        targetProduct: "수영복, 여행 가방", momentDate: "2026년 8월", postingDate: "2026년 8월", isMock: true
    },
    {
        ...
        title: "한라산 백록담 등반 도전", date: "2026년 10월",
        description: "가을 단풍 시즌 한라산 등반 과정과 준비물 소개.\n• 희망 협찬: 등산화, 등산 스틱, 등산 가방, 행동식\n• 이벤트 시기: 10월 말\n• 업로드 예정: 11월 초 완등 인증",
        tags: ["등산", "한라산", "운동"], followers: 40000,
        targetProduct: "아웃도어 의류/장비", momentDate: "2026년 10월", postingDate: "2026년 11월", isMock: true
    },
    ...
    // --- Parenting & Kids (Expanding) ---
    {
        ...
        title: "쌍둥이 돌잔치 준비 A to Z", date: "2026년 4월",
        description: "답례품 선정부터 성장 동영상 제작까지 모조리 공유해요.\n• 희망 협찬: 아기 정장, 답례품, 돌상 대여\n• 이벤트 시기: 4월 15일\n• 업로드 예정: 4월 30일 후기 영상",
        tags: ["육아", "돌잔치", "쌍둥이"], followers: 62000,
        targetProduct: "육아용품, 행사용품", momentDate: "2026년 4월", postingDate: "2026년 4월", isMock: true
    },
    {
        ...
        title: "아빠랑 문화센터 가는 날", date: "2026년 3월",
        description: "육아 휴직 중인 아빠의 문화센터 적응기.\n• 희망 협찬: 아기띠, 기저귀 가방, 유아 간식\n• 이벤트 시기: 3월 봄학기 개강\n• 업로드 예정: 매주 수요일",
        tags: ["육아빠", "문화센터", "육아브이로그"], followers: 15000,
        targetProduct: "유아 외출용품", momentDate: "2026년 3월", postingDate: "2026년 3월", isMock: true
    },
    {
        ...
        title: "신학기 아이방 인테리어해주기", date: "2026년 2월",
        description: "초등학교 입학하는 아이를 위해 책상과 침대를 바꿉니다.\n• 희망 협찬: 초등학생 책상, 의자, 스탠드, 침구\n• 이벤트 시기: 2월 입학 전\n• 업로드 예정: 2월 25일 룸투어",
        tags: ["아이방꾸미기", "초등맘", "입학준비"], followers: 89000,
        targetProduct: "키즈 가구, 학용품", momentDate: "2026년 2월", postingDate: "2026년 2월", isMock: true
    },
    {
        ...
        title: "어린이날 선물 BEST 5 추천", date: "2026년 5월",
        description: "아이들이 실제로 좋아하는 장난감 솔직 리뷰.\n• 희망 협찬: 인기 장난감, 보드게임\n• 이벤트 시기: 4월 말 촬영\n• 업로드 예정: 5월 1일 특집 영상",
        tags: ["장난감", "육아템", "선물추천"], followers: 250000,
        targetProduct: "완구", momentDate: "2026년 4월", postingDate: "2026년 5월", isMock: true
    },
    {
        ...
        title: "후기 이유식 큐브 대량생산", date: "2026년 6월",
        description: "한 번 만들어서 2주 편하게 먹는 토핑 이유식 노하우.\n• 희망 협찬: 이유식 마스터기, 큐브 틀, 이유식 용기\n• 이벤트 시기: 6월 초\n• 업로드 예정: 6월 10일",
        tags: ["이유식", "육아꿀팁", "레시피"], followers: 38000,
        targetProduct: "이유식 조리도구", momentDate: "2026년 6월", postingDate: "2026년 6월", isMock: true
    },
    ...
    // --- Pet (Expanding) ---
    {
        ...
        title: "고양이 다이어트 프로젝트", date: "2026년 4월",
        description: "뚱냥이 탈출을 위한 장난감 사냥 놀이와 식단 관리.\n• 희망 협찬: 다이어트 사료, 자동 장난감, 캣휠\n• 이벤트 시기: 3개월 장기 프로젝트\n• 업로드 예정: 4월부터 격주 연재",
        tags: ["고양이", "반려묘", "다이어트"], followers: 120000,
        targetProduct: "반려동물 사료/용품", momentDate: "2026년 4월", postingDate: "2026년 4월", isMock: true
    },
    {
        ...
        title: "우리 강아지 분리불안 훈련", date: "2026년 3월",
        description: "혼자 있는 강아지를 위한 펫CCTV 설치와 훈련 과정.\n• 희망 협찬: 펫카메라, 노즈워크 장난감, 진정 간식\n• 이벤트 시기: 3월\n• 업로드 예정: 3월 20일",
        tags: ["강아지훈련", "반려견", "펫테크"], followers: 18000,
        targetProduct: "펫 가전", momentDate: "2026년 3월", postingDate: "2026년 3월", isMock: true
    },
    {
        ...
        title: "자연주의 햄스터 케이지 꾸미기", date: "2026년 7월",
        description: "햄스터가 행복한 대형 아크릴 케이지 셋팅.\n• 희망 협찬: 베딩, 은신처, 쳇바퀴\n• 이벤트 시기: 7월 초\n• 업로드 예정: 7월 12일",
        tags: ["햄스터", "소동물", "케이지꾸미기"], followers: 45000,
        targetProduct: "소동물 용품", momentDate: "2026년 7월", postingDate: "2026년 7월", isMock: true
    },
    ...
    },
    {
        ...
        title: "2027년 다이어리 속지 무료 나눔", date: "2026년 12월",
        ...
        targetProduct: "디지털 문구", momentDate: "2026년 12월", postingDate: "2026년 12월", isMock: true
    },
    {
        ...
        title: "자이언트 얀 가방 만들기 라이브", date: "2026년 11월",
        description: "겨울 맞이 포근한 가방 만들기 원데이 클래스 라이브.\n• 희망 협찬: 뜨개실, 라벨, 포장용품\n• 이벤트 시기: 11월 11일 빼빼로데이\n• 업로드 예정: 라이브 방송",
        tags: ["뜨개질", "취미", "DIY"], followers: 58000,
        targetProduct: "DIY 키트", momentDate: "2026년 11월", postingDate: "2026년 11월", isMock: true
    },
    {
        ...
        title: "나만의 시그니처 라떼 만들기", date: "2026년 8월",
        description: "여름 덛위를 날려버릴 아이스 라떼 레시피 3종.\n• 희망 협찬: 원두, 시럽, 유리컵, 제빙기\n• 이벤트 시기: 8월 초\n• 업로드 예정: 8월 5일 홈카페 영상",
        tags: ["홈카페", "커피", "레시피"], followers: 210000,
        targetProduct: "커피 용품", momentDate: "2026년 8월", postingDate: "2026년 8월", isMock: true
    },
    {
        ...
        title: "한 달에 10권 읽기 챌린지", date: "2026년 10월",
        description: "독서의 계절 가을, 함께 책 읽을 구독자 모집.\n• 희망 협찬: 도서, 독서대, 북카페 이용권\n• 이벤트 시기: 10월 한 달\n• 업로드 예정: 매주 책 추천 영상",
        tags: ["독서", "책추천", "자기계발"], followers: 35000,
        targetProduct: "도서", momentDate: "2026년 10월", postingDate: "2026년 10월", isMock: true
    },
    {
        ...
        title: "시드머니 1억 모으기 과정 공개", date: "2026년 4월",
        description: "사회초년생의 월급 70% 저축과 주식 투자 기록.\n• 희망 협찬: 투자 관련 도서, 경제 신문 구독권\n• 이벤트 시기: 상시\n• 업로드 예정: 매월 월말 결산",
        tags: ["주식", "재테크", "저축"], followers: 12000,
        targetProduct: "금융 서비스", momentDate: "2026년 4월", postingDate: "2026년 4월", isMock: true
    },
    {
        ...
        title: "프리즈 서울 아트페어 브이로그", date: "2026년 9월",
        description: "세계적인 아트페어 프리즈 서울 현장을 담습니다.\n• 희망 협찬: 전시 티켓, 편안한 신발\n• 이벤트 시기: 9월 아트위크\n• 업로드 예정: 9월 10일",
        tags: ["전시", "미술", "문화생활"], followers: 49000,
        targetProduct: "문화/예술 티켓", momentDate: "2026년 9월", postingDate: "2026년 9월", isMock: true
    },
    ...
    // --- Wedding (New) ---
    {
        ...
        title: "D-100 결혼 준비 브이로그", date: "2026년 9월",
        description: "상견례부터 본식까지 리얼한 결혼 준비 과정을 담습니다.\n• 희망 협찬: 가전, 가구, 청첩장, 답례품\n• 이벤트 시기: 9월부터 매주\n• 업로드 예정: 매주 일요일",
        tags: ["결혼준비", "예비신부", "웨딩"], followers: 24000,
        targetProduct: "가전, 가구, 청첩장", momentDate: "2026년 9월", postingDate: "2026년 10월", isMock: true
    },

    // --- Guest Influencer (Su-min) Private Data ---
    {
        id: "ev_guest_1", influencer: "김수민", handle: "@im_breath_ing", creatorId: "guest_creator", verified: true, avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&h=400&fit=crop",
        category: "✈️ 여행", title: "7월 제주도 여름 휴가 브이로그", date: "2026년 7월",
        ...
        targetProduct: "항공, 숙박, 의류", momentDate: "2026년 7월", postingDate: "2026년 7월", isMock: true
    },
    {
        id: "ev_guest_2", influencer: "김수민", handle: "@im_breath_ing", creatorId: "guest_creator", verified: true, avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&h=400&fit=crop",
        category: "💄 뷰티", title: "데일리 썸머 메이크업 튜토리얼", date: "2026년 6월",
        description: "지속력 좋은 여름 무드 메이크업을 소개합니다.\n• 희망 협찬: 선크림, 쿠션 파운데이션, 워터프루프 아이라이너\n• 업로드 예정: 6월 초 릴스 & 숏츠",
        tags: ["메이크업", "여름뷰티", "지속력좋은"], followers: 5851,
        targetProduct: "화장품", momentDate: "2026년 6월", postingDate: "2026년 6월", isMock: true
    },
    {
        id: "ev_guest_3", influencer: "김수민", handle: "@im_breath_ing", creatorId: "guest_creator", verified: true, avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&h=400&fit=crop",
        category: "🥗 다이어트", title: "운동 시작! 필라테스 10회 챌린지", date: "2026년 5월",
        description: "운동 초보의 필라테스 적응기 및 식단 기록.\n• 희망 협찬: 요가복, 단백질 쉐이크, 스마트 워치\n• 업로드 예정: 주 2회 인스타그램 스토리 & 게시물",
        tags: ["오운완", "필라테스", "다이어트식단"], followers: 5851,
        targetProduct: "요가복, 건강식품", momentDate: "2026년 5월", postingDate: "2026년 5월", isMock: true
    },
    {
        id: "ev_guest_4", influencer: "김수민", handle: "@im_breath_ing", creatorId: "guest_creator", verified: true, avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&h=400&fit=crop",
        category: "👗 패션", title: "봄맞이 옷장 정리 & 룩북", date: "2026년 4월", status: "completed",
        description: "올해의 봄 패션 아이템 소개 및 룩북 영상.\n• 협찬 완료: 멜린 가디건, ABC 마트 스니커즈\n• 성과: 조회수 1.2만회, 댓글 80개",
        tags: ["봄코디", "룩북", "OOTD"], followers: 5851,
        targetProduct: "봄 의류", momentDate: "2026년 4월", postingDate: "2026년 4월", isMock: true
    },
    {
        id: "ev_guest_5", influencer: "김수민", handle: "@im_breath_ing", creatorId: "guest_creator", verified: true, avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&h=400&fit=crop",
        category: "✈️ 여행", title: "그랜드 하얏트 제주 호캉스 브이로그", date: "2026년 3월", status: "completed",
        description: "제주도 최고급 호텔에서의 힐링 브이로그.\n• 협찬 완료: 그랜드 하얏트 숙박권, 조식권\n• 성과: 유튜브 조회수 5천회 돌파",
        tags: ["호캉스", "제주여행", "그랜드하얏트"], followers: 5851,
        targetProduct: "호텔 숙박권", momentDate: "2026년 3월", postingDate: "2026년 3월", isMock: true
    }
];
